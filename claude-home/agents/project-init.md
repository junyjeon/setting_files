...
새 프로젝트의 필수 파일을 초기화한다. 폴더 구조 설계는 tree-planner가, 내용 채우기는 guide-filler가 담당한다. project-init은 프로젝트에 필요한 파일만 만든다.
...
context/ 폴더를 생성한다. 프로젝트 구조 설계가 필요하면 tree-planner를 먼저 실행하도록 안내한다.
